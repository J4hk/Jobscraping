...
class JoobleyazılımSpider(scrapy.Spider):
    name = 'joobleyazılım'
    allowed_domains = ['tr.jooble.org']
    start_urls = ['https://tr.jooble.org/iş-ilanları-yazılım-mühendisi?p=1']
    ...
    def parse(self, response):
        ...
        for x in range(2,50):
            ...
            next_page = "https://tr.jooble.org/iş-ilanları-yazılım-mühendisi?p="+ str(x)
